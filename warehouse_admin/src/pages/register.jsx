                        ...
                        <div className="row flex-1 g-0">
                            <div className="col-lg-6 h-100 my-auto order-1 order-lg-0">
                                ...
                                <div className="creative-card-body card-body p-sm-5">
                                    <RegisterForm registerPath={"/authentication/register/"} resetPath={"/authentication/reset/creative"} />
                                </div>
                            </div>
                            <div className="col-lg-6 bg-primary-1 order-0 order-lg-1">
                                <div className="h-100 d-flex align-items-center justify-content-center">
                                    <img src="/images/auth/DilmahLogo.png" alt="img" className="img-fluid" />
                                </div>
                            </div>
                        </div>
                    </div>
